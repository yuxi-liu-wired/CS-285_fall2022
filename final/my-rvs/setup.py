...
setuptools.setup(
    ...
    install_requires=[
        ...
        "gym==0.23.1", # 0.24 is broken (so why the hell did they release it?!), and 0.25 is a breaking change.
        "matplotlib",
        "numpy",
        "pandas",
        "swig", # necessary for box2d-py installation.
        "pytorch-lightning",
        "seaborn",
        "stable-baselines3<=1.2.0",  # we use ActorCriticPolicy's _get_latent function
        # "torch<=1.7.1",  # gcsl's rlutil breaks with torch==1.8.1
        # Not my fucking problem if I don't use GCSL!!!
        "tqdm",
        "wandb",
    ],
