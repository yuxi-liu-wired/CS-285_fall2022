...
def run_training(
    ...
    val_frac: float,
    use_gpu: bool,
    autogluon_policy_path: str,
) -> None:
    """Run the training with PyTorch Lightning and log to Weights & Biases."""
    policy = policies.LoadedAutoGluonModel(
        autogluon_policy_path,
        env_name=env_name,
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        choices=step.gym_goal_envs + step.d4rl_env_names,
    ...
    run_training(
        ...
        autogluon_policy_path=args.autogluon_policy_path,
    )
    ...
    if args.visualize:
        ...
        # Open the experiment log, find the rollout trajectories (generated during the `run_training` run)
        # and randomly take 2000 of them to draw a violin plot.
