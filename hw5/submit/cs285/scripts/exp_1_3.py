...
command_stem = [
    "python cs285/scripts/run_hw5_expl.py --no_gpu --env_name PointmassMedium-v0 --use_rnd --unsupervised_exploration --seed {s} --exp_name q1_rnd_med_seed{s}",
    "python cs285/scripts/run_hw5_expl.py --no_gpu --env_name PointmassHard-v0 --use_rnd --unsupervised_exploration --seed {s} --exp_name q1_rnd_hard_seed{s}",
