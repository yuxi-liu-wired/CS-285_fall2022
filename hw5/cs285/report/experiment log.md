...
Compare: the state density plot at the end of exploration phase:
...
The state density plot at the end of exploitation phase:
...
A comparative evaluation of the learning curves obtained via RND and random exploration in your report.
